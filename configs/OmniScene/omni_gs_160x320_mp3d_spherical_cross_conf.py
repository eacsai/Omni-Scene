...
# resume_from = '/data/qiwei/nips25/workdirs/omni_gs_160x320_mp3d_cylinder_pixel_volume/checkpoint-36000'
resume_from = False
...
near_point_cloud_range = [0.0, 0.0, 0.0, 16.0, 6.28, 3.14] # r, theta, phi
far_point_cloud_range = [0.0, 0.0, 0.0, 16.0, 6.28, 3.14] # r, theta, phi
point_cloud_range = [0.0, 0.0, 0.0, 16.0, 6.28, 3.14] # r, theta, phi
scale_theta = 1
scale_r = 1
scale_z = 1
    ...
    near_volume_gs=dict(
        ...
        encoder=dict(
            ...
            positional_encoding=dict(
                ...
                z=near_tpv_z_)),
        gs_decoder = dict(
            type='VolumeGaussianDecoderConf',
            tpv_theta=near_tpv_theta_,
            tpv_r=near_tpv_r_,
            tpv_z=near_tpv_z_,
            pc_range=near_point_cloud_range,
