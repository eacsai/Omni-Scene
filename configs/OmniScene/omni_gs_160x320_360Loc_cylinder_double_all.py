...
resume_from = "/data/qiwei/nips25/workdirs/omni_gs_160x320_mp3d_cylinder_double_all_z3/checkpoint-27000/model.safetensors"
# resume_from = False
...
model = dict(
    type='OmniGaussianCylinderVolumePixel',
